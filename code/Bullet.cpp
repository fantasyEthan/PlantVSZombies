...
Bullet::Bullet(int  x, int  y, int atk, const Image other,int bt, int vx, const Image other_bk) :Object(x,y,0, other, other_bk),Movable(1,vx,0), attack(atk), bulletType(bt) {
}
