...
Plant::Plant(int animationstatus, int movestatus, int po_x, int po_y, int hp, int p, std::string t) : Animation(animationstatus), Movable(movestatus), Object(po_x, po_y, hp), price(p),type(t)
{
